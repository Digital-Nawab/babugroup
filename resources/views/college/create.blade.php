...
<div class="content container-fluid">
    ...
    <div class="row">
        ...
        @endif
        <div class="col-sm-12">
            <form action="{!! url('admin/college/add-college') !!}" method="POST" enctype="multipart/form-data">
                @csrf
                <div class="card">
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-4 mb-3">
                                ...
                                <input type="text" class="form-control" id="collegeName" name="college_name"
                                    placeholder="College name" value="{{ old('college_name') }}" required>
                            ...
                            <div class="col-md-4 mb-3">
                                ...
                                <input type="text" class="form-control" id="collegeSlug" name="slug_url"
                                    placeholder="College URL" value="{{ old('slug_url') }}" required readonly>
                                @error('slug_url') <span class="text-danger">{{ $message }}</span> @enderror
                            </div>
                            <div class="col-md-4 mb-3">
                                <label for="validationCustomUsername">College Code <span
                                        class="text-danger">*</span></label>
                                <input type="text" maxlength="10" minlength="3" class="form-control" name="college_code"
                                    placeholder="College Code" value="{{ old('college_code') }}" required>
                                @error('college_code') <span class="text-danger">{{ $message }}</span> @enderror
                            </div>
                            <div class="col-md-4 mb-3">
                                <label for="validationCustomUsername">Contact Number <span
                                        class="text-danger">*</span></label>
                                <input type="text" maxlength="13" minlength="10" class="form-control"
                                    name="college_contact" placeholder="Contact Number"
                                    value="{{ old('college_contact') }}" required>
                            ...
                            <div class="col-md-4 mb-3">
                                ...
                                <input type="text" class="form-control" name="college_email" placeholder="College Email"
                            ...
                            <div class="col-md-4 mb-3">
                                ...
                                <input type="text" class="form-control" maxlength="15" minlength="15" name="gstn"
                                    placeholder="Contact Number" value="{{ old('gstn') }}">
                                @error('gstn') <span class="text-danger">{{ $message }}</span> @enderror
                            </div>
                            <div class="col-md-4 mb-3">
                                <label for="collegeLogo">College Logo</label>
                                <input type="file" class="form-control" id="collegeLogo" name="logo">
                            ...
                            <div class="col-md-11 mb-3">
                                ...
                                <textarea type="text" class="form-control" name="description" width="100%"
                                    placeholder="College Description">{{ old('description') }}</textarea>
                                @error('description') <span class="text-danger">{{ $message }}</span> @enderror
                            </div>
                            <div class="col-md-1 mb-3">
                                <label for="previewImage">Preview</label>
                                <img id="previewImage" src="https://www.babuedu.com/assets/img/logo/logo.png"
                                    class="img-fluid" alt="Preview"
                                    style="width: 100%; height: auto; border: 1px solid #ddd; padding: 3px ">
                            </div>
                        </div>
                    </div>
                </div>
            ...
            <div class="card-body">
                <div class="row">
                    ...
                    <div class="col-md-4 mb-3">
                        ...
                        <input type="email" class="form-control" name="email" placeholder="User Personal Email"
                            value="{{ old('email') }}" required>
                        @error('email') <span class="text-danger">{{ $message }}</span> @enderror
                    </div>
                    <div class="col-md-4 mb-3">
                        <label for="validationDefaultUsername">Personal Contact Number <span
                                class="text-danger">*</span></label>
                        <input type="text" class="form-control" maxlength="10" minlength="10" name="contact"
                            placeholder="Personal Contact Number" value="{{ old('contact') }}" required>
                        @error('contact') <span class="text-danger">{{ $message }}</span> @enderror
                    </div>
                    <div class="col-md-6 mb-3">
                        <label for="password">Login Password <span class="text-danger">*</span></label>
                        <input type="password" class="form-control" name="password" placeholder="College Login Password"
                            required>
