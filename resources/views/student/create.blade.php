                            ...
                            <div class="row">
                                <div class="col-12 col-sm-4">
                                    <div class="form-group">
                                        ...
                                        <select class="form-control select2" id="academic_year" name="academic[year]" style="width: 100%; height: 40px" required>
                                ...
                                <div class="col-12 col-sm-4">
                                    <div class="form-group">
                                        <label>Academic Course Type <span style="color: red">*</span></label>
                                        <select class="form-control select2" name="academic[course_type]"
                                                id="academic_course_type" style="width: 100%; height: 40px" required>
                                            <option value="">Select </option>
