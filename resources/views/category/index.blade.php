                                ...
                                @if (count($data) > 0)
                                    @foreach ($data as $key => $row)
                                        <tr>
                                            ...
                                            <td class="text-end">
                                                <a href="javascript:void(0)" class="btn btn-primary btn-sm editYear" data-id="{!! base64_encode($row->id) !!}" data-name="{!! $row->name !!}"  data-location="{!! $row->location !!}" data-bs-toggle="tooltip" data-bs-placement="bottom" data-bs-title="Edit Subject">
